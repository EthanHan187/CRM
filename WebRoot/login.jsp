					...
					<TR>
						<td>
							<select id="roleName" name="roleName" class="input" style="margin-top: 15px;height: 24px">
								...
								<option value="Administrator"  ${'Administrator'==user.roleName?'selected':'' }>系统管理员</option>
								<option value="Senior Executive"  ${'Senior Executive'==user.roleName?'selected':'' }>高管</option>
								<option value="Sales Supervisor"  ${'Sales Supervisor'==user.roleName?'selected':'' }>销售主管</option>
							</select>
						</td>
					</TR>
				</TBODY>
