		...
		$("#fm").form("submit",{
			...
			onSubmit:function(){
				...
				if(newPassword!=newPassword2){
					$.messager.alert("系统提示","新密码两次输入不一致！");
					return false;
				}
				return true;
			},
...
<div region="north" style="height: 78px;background-color: #E0ECFF">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<img alt="logo" src="${pageContext.request.contextPath}/images/bglogo_2.png">
			</td>
			<td valign="bottom" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>当前用户：</strong></font>${currentUser.trueName }【${currentUser.roleName }】
			</td>
		</tr>
	</table>
</div>
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs" >
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" >
				<img alt="logo" src="${pageContext.request.contextPath}/images/2.png">
...
<div region="west" style="width: 200px" title="系统功能导航" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		<div title="营销管理" data-options="selected:true,iconCls:'icon-yxgl'" style="padding: 10px">
			<a href="javascript:openTab('销售机会管理','saleChanceManage.jsp','icon-yxjhgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-yxjhgl'" style="width: 150px">销售机会管理</a>
		...
		<div title="客户服务管理" data-options="iconCls:'icon-fwgl'" style="padding:10px">
		...
		<!--  <div title="订单管理" data-options="selected:true,iconCls:'icon-lsdd'" style="padding: 10px">
			<a href="javascript:openTab('订单管理','orderPage.jsp','icon-fwgd')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-fwgd'" style="width: 150px">订单管理</a>
		</div>-->
...
<div region="south" style="height: 25px;padding: 5px" align="center">
	Graduation Project By Han Yixuan(2016)
</div>
