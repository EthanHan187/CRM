...
public class UserController {
	...
	public String login(User user,HttpServletRequest request)throws Exception{
		...
		if(resultUser==null){
			...
			request.setAttribute("errorMsg", "登录信息输入错误");
			return "login";
		}else{
	...
	public String customerManagerComboList(HttpServletResponse response)throws Exception{
		Map<String,Object> map=new HashMap<String,Object>();
		map.put("roleName", "Customer Manager");
		List<User> userList=userService.find(map);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/salesmanComboList")
	public String salesmanComboList(HttpServletResponse response)throws Exception{
		Map<String,Object> map=new HashMap<String,Object>();
		map.put("roleName", "Salesman");
		List<User> userList=userService.find(map);
		JSONArray row=JSONArray.fromObject(userList);
		ResponseUtil.write(response, row);
		return null;
